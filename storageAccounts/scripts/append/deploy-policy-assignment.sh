...
# Variables
policyAssignmentName="storage-account-default-action-should-be-deny-assignment"
policyDefinitionName="storage-account-default-action-should-be-deny-definition"
location="WestEurope"
